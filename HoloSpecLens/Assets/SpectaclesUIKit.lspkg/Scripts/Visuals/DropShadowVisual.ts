...
export class DropShadowVisual extends Visual {
  ...
  public set size(size: vec3) {
    ...
    super.size = size
    if (this.initialized) {
      this.dropShadow.size = new vec2(
        size.x + this.currentSizeOffset.x,
        size.y + this.currentSizeOffset.y
      )
    }
  }
  ...
  protected updateSizeOffset(sizeOffset: vec2) {
    ...
    animate({
      ...
      update: (t) => {
        ...
        this.dropShadow.size = new vec2(
          this.size.x + this.currentSizeOffset.x,
          this.size.y + this.currentSizeOffset.y
        )
      },
